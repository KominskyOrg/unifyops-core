...
def test_init_module_not_found():
    ...
    with patch("os.path.exists", return_value=False):
        ...
        request_data = {"module_path": "non-existent-module", "variables": {}}
...
def test_plan_module(mock_exists, mock_terraform_service):
    ...
    # Request data
    request_data = {"module_path": "ec2", "variables": {"instance_type": "t2.micro"}}
...
def test_apply_module(mock_exists, mock_terraform_service):
    ...
    outputs = {"instance_id": {"value": "i-12345678"}, "public_ip": {"value": "1.2.3.4"}}
