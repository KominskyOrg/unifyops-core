...
class UnauthorizedError(AppException):
    ...
    def __init__(self, message: str = "Unauthorized", details: Optional[List[Dict[str, Any]]] = None):
        super().__init__(message=message, details=details)
...
class TerraformError(AppException):
    ...
    def __init__(self, message: str = "Terraform operation failed", details: Optional[List[Dict[str, Any]]] = None):
        super().__init__(message=message, details=details)
...
class AsyncTaskError(AppException):
    ...
    def __init__(self, message: str = "Async task execution failed", details: Optional[List[Dict[str, Any]]] = None):
        super().__init__(message=message, details=details)
